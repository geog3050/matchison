...
mode = input("Please choose a calculation method - type one of the following commands and hit Enter: min, max, avg ")
count = int(input("Please indicate how many values you would like to be computed - enter an integer and press Enter: "))
values = list()
